...
exports.payment_partial =async function(context, event, callback) {
    ...
    let collect_question="Please say or enter the amount you want to pay, for example, you can say fifty dollars and twenty five cents. or you can enter five zero asterisk two five ."; // Default 
